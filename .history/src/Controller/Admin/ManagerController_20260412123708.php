...
class ManagerController extends AbstractController
{
    ...
    public function add(
        ...
        dump($request->getMethod(), $request->request->all());
die();
        ...
        return $this->render('admin/managers/form.html.twig', [
            ...
            'mode'      => 'add',
            'formAction' => $this->generateUrl('app_admin_managers_add'),
            'errors'    => $errors,
            'old'       => $old,
        ]);
    }
    ...
    public function edit(
        ...
        return $this->render('admin/managers/form.html.twig', [
            ...
            'companies' => $companyRepo->findAll(),
            'mode'      => 'edit',
            'formAction' => $this->generateUrl('app_admin_managers_edit', ['id' => $manager->getId()]),
            'errors'    => $errors,
            'old'       => $old,
        ]);
    }
