...
class Market
{
    ...
    public function setCountry_code(string $country_code): self
    {
    ...
    public function setIs_eu(?bool $is_eu): self
    {
        $this->is_eu = $is_eu;
        return $this;
    }
    ...
    #[ORM\OneToMany(targetEntity: Companie::class, mappedBy: 'market')]
