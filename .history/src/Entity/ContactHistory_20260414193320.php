...
class ContactHistory
{
    ...
    #[ORM\ManyToOne(targetEntity: Companie::class, inversedBy: 'contactHistorys')]
    #[ORM\JoinColumn(name: 'target_company_id', referencedColumnName: 'id')]
    private ?Companie $companie = null;
    ...
    public function getContact_date(): ?\DateTimeInterface
    {
        return $this->contact_date;
    }

    public function setContact_date(\DateTimeInterface $contact_date): self
    {
