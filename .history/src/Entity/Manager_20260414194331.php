...
class Manager
{
    ...
    public function addCompany(Company $companie): self
    {
        if (!$this->getCompanys()->contains($companie)) {
            $this->getCompanys()->add($companie);
        }
        return $this;
    }

    public function removeCompany(Company $companie): self
    {
        $this->getCompanys()->removeElement($companie);
        return $this;
    }
