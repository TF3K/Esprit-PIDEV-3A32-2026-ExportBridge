...
class Setting
{
    ...
    public function setPushNotifications(?bool $push_notifications): self
    {
    ...
    public function isCertificateExpiryAlerts(): ?bool
    {
        return $this->certificate_expiry_alerts;
    }

    public function setCertificateExpiryAlerts(?bool $certificate_expiry_alerts): self
    {
    ...
    public function setAlertDaysBefore(?int $alert_days_before): self
    {
    ...
    public function setEmailNotifications(?bool $email_notifications): static
    {
        $this->email_notifications = $email_notifications;
    ...
    public function setPushNotifications(?bool $push_notifications): static
    {
        $this->push_notifications = $push_notifications;
    ...
    public function setCertificateExpiryAlerts(?bool $certificate_expiry_alerts): static
    {
        $this->certificate_expiry_alerts = $certificate_expiry_alerts;
    ...
    public function setAlertDaysBefore(?int $alert_days_before): static
    {
        $this->alert_days_before = $alert_days_before;
