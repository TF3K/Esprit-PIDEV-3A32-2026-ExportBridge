...
class Signature
{
    ...
    public function getSignatory_name(): ?string
    {
        return $this->signatory_name;
    }

    public function setSignatory_name(string $signatory_name): self
    {
    ...
    public function getSignatory_title(): ?string
    {
        return $this->signatory_title;
    }

    public function setSignatory_title(?string $signatory_title): self
    {
    ...
    public function getSigned_date(): ?\DateTimeInterface
    {
        return $this->signed_date;
    }

    public function setSigned_date(\DateTimeInterface $signed_date): self
    {
    ...
    public function getDigital_signature(): ?string
    {
        return $this->digital_signature;
    }

    public function setDigital_signature(?string $digital_signature): self
    {
    ...
    public function setSignatoryName(string $signatory_name): static
    {
        $this->signatory_name = $signatory_name;
    ...
    public function setSignatoryTitle(?string $signatory_title): static
    {
        $this->signatory_title = $signatory_title;
    ...
    public function setSignedDate(\DateTime $signed_date): static
    {
        $this->signed_date = $signed_date;
    ...
    public function setDigitalSignature(?string $digital_signature): static
    {
        $this->digital_signature = $digital_signature;
