...
class Manager
{
    ...
    #[ORM\ManyToOne(targetEntity: Compan::class, inversedBy: 'managers')]
    #[ORM\JoinColumn(name: 'company_id', referencedColumnName: 'id')]
    private ?Compan $companie = null;

    public function getCompan(): ?Compan
    {
        return $this->companie;
    }

    public function setCompan(?Compan $companie): self
    {
    ...
    #[ORM\OneToMany(targetEntity: Compan::class, mappedBy: 'manager')]
    private Collection $companies;

    /**
     * @return Collection<int, Compan>
     */
    public function getCompans(): Collection
    {
    ...
    public function addCompan(Compan $companie): self
    {
        if (!$this->getCompans()->contains($companie)) {
            $this->getCompans()->add($companie);
        }
        return $this;
    }

    public function removeCompan(Compan $companie): self
    {
        $this->getCompans()->removeElement($companie);
        return $this;
    }
