 ...
 */
final class Version20260418183744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE signatures DROP FOREIGN KEY IF EXISTS `signatures_ibfk_1`');
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS `contact_history_ibfk_1`');
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS `contact_history_ibfk_2`');
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS `contact_history_ibfk_3`');
        $this->addSql('ALTER TABLE managers DROP FOREIGN KEY IF EXISTS `fk_company_manager`');
        $this->addSql('ALTER TABLE partnerships DROP FOREIGN KEY IF EXISTS `partnerships_ibfk_1`');
        $this->addSql('ALTER TABLE partnerships DROP FOREIGN KEY IF EXISTS `partnerships_ibfk_2`');
        $this->addSql('ALTER TABLE products DROP FOREIGN KEY IF EXISTS `products_ibfk_1`');
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY IF EXISTS `notifications_ibfk_1`');
        $this->addSql('ALTER TABLE settings DROP FOREIGN KEY IF EXISTS `settings_ibfk_1`');
        $this->addSql('ALTER TABLE certificate_requirements DROP INDEX IF EXISTS idx_market_id');
        ...
        $this->addSql('ALTER TABLE certificates DROP INDEX IF EXISTS idx_company_id');
        $this->addSql('DROP INDEX IF EXISTS IDX_8D26FB5F979B1AD6 ON certificates');
        $this->addSql('CREATE INDEX IDX_8D26FB5F979B1AD6 ON certificates (company_id)');
        $this->addSql('ALTER TABLE collaborations DROP FOREIGN KEY IF EXISTS `collaborations_ibfk_1`');
        $this->addSql('ALTER TABLE collaborations DROP INDEX IF EXISTS idx_start_date');
        $this->addSql('ALTER TABLE collaborations DROP INDEX IF EXISTS idx_status');
        ...
        $this->addSql('ALTER TABLE collaborations DROP INDEX IF EXISTS idx_partnership_id');
        $this->addSql('DROP INDEX IF EXISTS IDX_B9B3849A6AE7F85 ON collaborations');
        $this->addSql('CREATE INDEX IDX_B9B3849A6AE7F85 ON collaborations (partnership_id)');
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY IF EXISTS `companies_ibfk_1`');
        ...
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY IF EXISTS `FK_MARKET_COMPANY`');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_8244AA3AC5B0DDF5 ON companies');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_8244AA3A622F3F37 ON companies');
        ...
        $this->addSql('ALTER TABLE contact_history DROP COLUMN IF EXISTS target_company_id, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE source_company_id source_company_id INT DEFAULT NULL, CHANGE contact_date contact_date DATETIME NOT NULL, CHANGE contact_type contact_type VARCHAR(255) NOT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL, CHANGE contacted_by_manager_id contacted_by_manager_id INT DEFAULT NULL');
        $this->addSql('DROP INDEX IF EXISTS idx_source_company ON contact_history');
        $this->addSql('DROP INDEX IF EXISTS IDX_BD9551CAEB2F6BF2 ON contact_history');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_BD9551CA570C3D7A ON contact_history');
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS reset_password_request (id INT AUTO_INCREMENT NOT NULL, selector VARCHAR(20) NOT NULL, hashed_token VARCHAR(100) NOT NULL, requested_at DATETIME NOT NULL, expires_at DATETIME NOT NULL, user_id INT NOT NULL, INDEX IDX_7CE748AA76ED395 (user_id), PRIMARY KEY (id), CONSTRAINT FK_7CE748AA76ED395 FOREIGN KEY (user_id) REFERENCES managers (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('DROP INDEX IF EXISTS fk_company_manager ON managers');
        $this->addSql('DROP INDEX IF EXISTS IDX_A949E006979B1AD6 ON managers');
        ...
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY IF EXISTS FK_6000B0D3783E3463');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_6000B0D3783E3463 ON notifications');
        ...
        $this->addSql('ALTER TABLE partnerships DROP INDEX IF EXISTS idx_source_company, ADD INDEX idx_source_company (source_company_id)');
        ...
        $this->addSql('ALTER TABLE partnerships DROP COLUMN IF EXISTS target_company_id, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE source_company_id source_company_id INT DEFAULT NULL, CHANGE status status VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) DEFAULT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE last_updated last_updated DATETIME NOT NULL');
        $this->addSql('ALTER TABLE partnerships DROP FOREIGN KEY IF EXISTS FK_2AE65832EB2F6BF2');
        ...
        $this->addSql('ALTER TABLE products DROP FOREIGN KEY IF EXISTS `categories_ibfk_1`');
        $this->addSql('DROP INDEX IF EXISTS idx_hs_code ON products');
        $this->addSql('ALTER TABLE products CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE company_id company_id INT DEFAULT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE hs_code hs_code VARCHAR(255) DEFAULT NULL, CHANGE quantity quantity NUMERIC(10, 2) NOT NULL, CHANGE unit unit VARCHAR(255) DEFAULT NULL, CHANGE unit_price unit_price NUMERIC(10, 2) NOT NULL, CHANGE currency currency VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME NOT NULL, CHANGE last_updated last_updated DATETIME NOT NULL');
        $this->addSql('ALTER TABLE products DROP FOREIGN KEY IF EXISTS FK_B3BA5A5A979B1AD6');
        $this->addSql('ALTER TABLE products ADD CONSTRAINT FK_B3BA5A5A979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id)');
        $this->addSql('ALTER TABLE products DROP FOREIGN KEY IF EXISTS FK_B3BA5A5A12469DE2');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_B3BA5A5A979B1AD6 ON products');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_B3BA5A5A12469DE2 ON products');
        ...
        $this->addSql('ALTER TABLE settings DROP FOREIGN KEY IF EXISTS FK_E545A0C5783E3463');
        ...
        $this->addSql('DROP INDEX IF EXISTS UNIQ_E545A0C5783E3463 ON settings');
        ...
        $this->addSql('ALTER TABLE signatures DROP FOREIGN KEY IF EXISTS FK_1A7B360C99223FFD');
        ...
        $this->addSql('DROP INDEX IF EXISTS IDX_1A7B360C99223FFD ON signatures');
        ...
        $this->addSql('ALTER TABLE certificates DROP FOREIGN KEY IF EXISTS FK_8D26FB5F979B1AD6');
        $this->addSql('ALTER TABLE certificates ADD CONSTRAINT FK_8D26FB5F979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id)');
        $this->addSql('ALTER TABLE collaborations DROP FOREIGN KEY IF EXISTS FK_B9B3849A6AE7F85');
        ...
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY IF EXISTS FK_8244AA3AC5B0DDF5');
        ...
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS FK_BD9551CAEB2F6BF2');
        ...
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS FK_BD9551CA570C3D7A');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('SET FOREIGN_KEY_CHECKS=0');
        $this->addSql('ALTER TABLE reset_password_request DROP FOREIGN KEY IF EXISTS FK_7CE748AA76ED395');
        ...
        $this->addSql('ALTER TABLE collaborations ADD CONSTRAINT FK_B9B3849A6AE7F85 FOREIGN KEY (partnership_id) REFERENCES partnerships (id)');
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY IF EXISTS FK_8244AA3AC5B0DDF5');
        $this->addSql('ALTER TABLE companies DROP FOREIGN KEY IF EXISTS FK_8244AA3A622F3F37');
        ...
        $this->addSql('ALTER TABLE contact_history DROP FOREIGN KEY IF EXISTS FK_BD9551CA570C3D7A');
        $this->addSql('ALTER TABLE contact_history ADD CONSTRAINT FK_BD9551CA570C3D7A FOREIGN KEY (contacted_by_manager_id) REFERENCES managers (id)');
        $this->addSql('ALTER TABLE managers DROP FOREIGN KEY IF EXISTS FK_A949E006979B1AD6');
        ...
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY IF EXISTS FK_6000B0D3783E3463');
        $this->addSql('ALTER TABLE notifications ADD CONSTRAINT FK_6000B0D3783E3463 FOREIGN KEY (manager_id) REFERENCES managers (id)');
        $this->addSql('ALTER TABLE partnerships DROP INDEX IF EXISTS UNIQ_2AE65832EB2F6BF2, ADD INDEX idx_source_company (source_company_id)');
        $this->addSql('ALTER TABLE partnerships DROP FOREIGN KEY IF EXISTS FK_2AE65832EB2F6BF2');
