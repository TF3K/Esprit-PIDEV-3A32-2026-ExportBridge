...
class Company
{
    ...
    public function getTaxNumber(): ?string { return $this->tax_number; }
    public function setTaxNumber(?string $tax_number): self { $this->tax_number = $tax_number; return $this; }

    #[ORM\Column(type: 'string', nullable: true)]
    private ?string $registration_number = null;

    public function getRegistrationNumber(): ?string { return $this->registration_number; }
    public function setRegistrationNumber(?string $registration_number): self { $this->registration_number = $registration_number; return $this; }
    ...
    public function setContactEmail(?string $contact_email): self { $this->contact_email = $contact_email; return $this; }

    #[ORM\Column(type: 'string', nullable: true)]
    private ?string $contact_phone = null;

    public function getContactPhone(): ?string { return $this->contact_phone; }
    public function setContactPhone(?string $contact_phone): self { $this->contact_phone = $contact_phone; return $this; }
    ...
    public function setWarnings(?int $warnings): self { $this->warnings = $warnings; return $this; }

    #[ORM\Column(type: 'boolean', nullable: true)]
    private ?bool $is_banned = null;

    public function isBanned(): ?bool { return $this->is_banned; }
    public function setIsBanned(?bool $is_banned): self { $this->is_banned = $is_banned; return $this; }
    ...
    public function getContractHash(): ?string { return $this->contractHash; }
    public function setContractHash(?string $contractHash): self { $this->contractHash = $contractHash; return $this; }
    ...
    public function getLastUpdated(): \DateTimeInterface { return $this->last_updated; }
    public function setLastUpdated(\DateTimeInterface $last_updated): self { $this->last_updated = $last_updated; return $this; }
    ...
    public function getCompanyManager(): ?Manager { return $this->companyManager; }
    public function setCompanyManager(?Manager $companyManager): self { $this->companyManager = $companyManager; return $this; }
