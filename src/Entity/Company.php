...
class Company
{
    ...
    #[ORM\OneToMany(targetEntity: Partnership::class, mappedBy: 'company')]
    private Collection $partnerships;

    public function getPartnership(): ?Partnership
    {
        return $this->getPartnerships()->first() ?: null;
    }

    /**
     *  Collection<int, Partnership>
     */
    public function getPartnerships(): Collection
    {
        if (!$this->partnerships instanceof Collection) {
    ...
    public function addPartnership(Partnership $partnership): self
    {
        if (!$this->getPartnerships()->contains($partnership)) {
            $this->getPartnerships()->add($partnership);
            $partnership->setCompany($this);
        }
        return $this;
    }
    ...
    {
        if ($this->getPartnerships()->removeElement($partnership)) {
            if ($partnership->getCompany() === $this) {
