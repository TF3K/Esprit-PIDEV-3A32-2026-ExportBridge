...
class CertificateImageFactory
{
    public function generate(Certificate $certificate): string
    {
        ...
        $country = $this->text($certificate->getCountryOfOrigin() ?: 'N/A');
        ...
        $descriptionSvg = '';
        $y = 342;
        foreach (array_slice($this->wrap($description, 92), 0, 4) as $line) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="700" viewBox="0 0 1000 700">
  ...
  <rect x="90" y="72" width="820" height="556" fill="#1e2852"/>
