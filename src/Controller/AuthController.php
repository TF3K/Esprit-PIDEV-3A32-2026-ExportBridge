    ...
    public function register(
        ...
        if ($request->isMethod('POST')) {
            ...
            if (empty($errors)) {
                ...
                $selectedCompany = $companyId ? $companyRepo->find($companyId) : null;
                if ($selectedCompany) {
                    $manager->setCompany($selectedCompany);
                    if (!$selectedCompany->getManager()) {
                        $selectedCompany->setManager($manager);
                    }
                } else {
                    $companyName = trim($firstName . ' ' . $lastName);
                    $company = new Company();
                    $company->setCompanyName(($companyName !== '' ? $companyName : 'My') . ' Company');
